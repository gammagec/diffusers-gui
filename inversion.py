...
from diffusers_gui import Config, Namespace

class DummySafetyChecker(StableDiffusionSafetyChecker):
	def __init__(self):
		self.__module__ = "dummy.safety"
...
paths = [
	  "F:/capture/b_1/b_1.png",
	  "F:/capture/back1/image1.png",
	  "F:/capture/l/1.png",
	  "F:/capture/l/2.png",
	  "F:/capture/l/3.png",
	  "F:/capture/l/4.png",
...
images = list(filter(None,[download_image(path) for path in paths]))
...
text_encoder = CLIPTextModel.from_pretrained(
	pretrained_model_path, subfolder="text_encoder", use_auth_token=True
)
vae = AutoencoderKL.from_pretrained(
	pretrained_model_path, subfolder="vae", use_auth_token=True
)
unet = UNet2DConditionModel.from_pretrained(
	pretrained_model_path, subfolder="unet", use_auth_token=True
)
